...
import { addStudent, deleStudent, getAllStudent, updateStudent } from './store/slices/studentSlices';
...
const App: React.FC = () => {
  ...
  const handleDelete = (id: number) => {
    if (confirm('Xác nhận xóa học sinh?')){
dispatch(deleStudent(id))
    }
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-gray-50 min-h-screen">
      ...
      <StudentSearchSortFilter
        ...
        onClear={handleClearFilters} grades={[]}      />
